...
c1 = Company.objects.create(name="Acme Corp", amount_raised=500000)
...
c2 = Company.objects.create(name="Bright AI", amount_raised=5000000)
...
# Company 3 - Mixed
c3 = Company.objects.create(name="NovaSpark", amount_raised=None)
